...
class DummyEventService : EventService {
    private var eventList: ArrayList<Article> = arrayListOf(
        Article(0,"앱센터","동아리","뭐라구?앱센터 13기 신입 멤버를 모집한다구?","위하여 물방아 작고 옷을 청춘 따뜻한 낙원을 이상의 피부가 봄바람이다. 인도하겠다는 할지니, 몸이 청춘에서만 튼튼하며, 발휘하기 천고에 끝까지 것이다. 대중을 인류의 살았으며, 같은 유소년에게서 반짝이는 보라. 용기가 그들에게 꽃 소담스러운 위하여 광야에서 능히 칼이다. 곧 생의 꾸며 수 쓸쓸하랴? 눈에 없으면 소금이라 이것은 아름다우냐? 끓는 들어 대고, 밝은 있는 있으랴? 같은 속에 꽃 곧 할지니, 생명을 사막이다. 이상을 열락의 이성은 없는 인간이 사랑의 피는 보내는 아니다. 이상의 인류의 반짝이는 능히 가진 노래하며 위하여 것이다. 있는 따뜻한 곳으로 수 끓는다.\n" +
            ...
            R.drawable.img_home_board_sample_image1,"2021-03-22 07:00:01","2021.03.26 07:12:01","2021.03.14 07:00:01",717),
        Article(1,"수달","대회 공모전","으헝헝 나는 감자","수달 귀엽다. 배고프다.\n이 세상에서 제일 맛있는 음식은 닭발~!",
            R.drawable.img_profile,"2001.03.14 07:10:01","2001.07.17 07:17:01","2001.01.01 08:00:01",123),
        Article(2,"컴퓨터공학부","간식나눔","알파카파카","알파카털로 만든 파카는 알파카파카\n알파카파카를 팔고싶으면?\n\n\n알파카파카파까?",
            R.drawable.img_home_board_sample_image2,"2022.01.25 18:26:01","2022.02.28 20:00:01","2022.01.23 07:00:01",123))
